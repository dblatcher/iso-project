...
export const figures = [
    ...
    new CharacterFigure({ x: 3, y: 6, sprite: duckSprite, facing: DIRECTION.north }, 'team2', { name: 'Mary', move: 4, health: 1, action: 1 }),
    new CharacterFigure({ x: 4, y: 6, sprite: manSprite, facing: DIRECTION.north }, 'team2', { name: 'Gregor', move: 4, health: 1, action: 1 }),
]
